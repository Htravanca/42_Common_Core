...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/11 22:16:26 by hepereir          #+#    #+#             */
/*   Updated: 2024/07/11 22:16:28 by hepereir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_total_cost_calc(t_stack_node **lst)
{
	...
	while (temp)
	{
		temp->cost->total_cost = temp->cost->ra + temp->cost->rb
			+ temp->cost->rr + temp->cost->rra + temp->cost->rrb
			+ temp->cost->rrr;
		temp = temp->next;
	}
}
...
void	ft_cost_calc_auxa(t_stack_node **a, t_stack_node *temp_a,
		t_stack_node *temp_b)
{
	int	aux_up;
	int	aux_dw;
